    ...
    (
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
          <span style={{ fontSize: '68px', fontWeight: 800, color: 'white', lineHeight: 1.05 }}>
          ...
          >
            Train live, 1-on-1, from anywhere — with Coach Himanshu
          </span>
        </div>
        ...
        <span style={{ position: 'absolute', bottom: '24px', fontSize: '14px', color: 'rgba(156,163,175,0.5)', fontWeight: 500 }}>
          coachhimanshu.com/online-personal-trainer
        </span>
      </div>
    ),
    { ...size }
