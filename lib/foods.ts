...
const RAW: RawFood[] = [
  ...
  { slug: 'green-salad', name: 'Green Salad (no dressing)', aliases: ['salad', 'kachumber'], category: 'Staples & Basics', per100g: { kcal: 25, protein: 1, carbs: 5, fat: 0.2 }, servings: [katori(100), bowl(200)], source: 'IFCT' },
  { slug: 'cucumber', name: 'Cucumber', aliases: ['kheera', 'kakdi'], category: 'Staples & Basics', per100g: { kcal: 15, protein: 0.7, carbs: 3.6, fat: 0.1 }, servings: [katori(100)], source: 'USDA' },
  { slug: 'tomato', name: 'Tomato', aliases: ['tamatar'], category: 'Staples & Basics', per100g: { kcal: 18, protein: 0.9, carbs: 3.9, fat: 0.2 }, servings: [piece(80, 'tomato')], source: 'USDA' },
];
