    ...
    subCategories: [
      {
        ...
        videos: [
          ...
          { id: 'cTlhjVnqWO7', title: 'Squats', embedUrl: 'https://go.screenpal.com/player/cTlhjVnqWO7' },
          { id: 'cTlhjVnqWth', title: 'Calf Raise', embedUrl: 'https://go.screenpal.com/player/cTlhjVnqWth' },
          { id: 'cTlhjVnqWOM', title: 'Ankle Rotation', embedUrl: 'https://go.screenpal.com/player/cTlhjVnqWOM' },
        ],
      },
      {
        id: 'hw_chest',
        ...
        parentId: 'homeWorkout',
        videos: [
          { id: 'cTleXynqM8B', title: 'Push Up', embedUrl: 'https://go.screenpal.com/player/cTleXynqM8B' },
          { id: 'cTleXynqM8A', title: 'Knee Push Ups', embedUrl: 'https://go.screenpal.com/player/cTleXynqM8A' },
          { id: 'cOfVD5nTBOQ', title: 'Wall Push Up', embedUrl: 'https://go.screenpal.com/player/cOfVD5nTBOQ' },
          ...
          { id: 'cOfVbnnTBUa', title: 'Declined Push Up', embedUrl: 'https://go.screenpal.com/player/cOfVbnnTBUa' },
          { id: 'cOfVbcnTBUX', title: 'Inclined Push Up', embedUrl: 'https://go.screenpal.com/player/cOfVbcnTBUX' },
        ],
      },
      {
        id: 'hw_back',
        ...
        parentId: 'homeWorkout',
        videos: [
          { id: 'cTleIhnqLF3', title: 'Superman Hold', embedUrl: 'https://go.screenpal.com/player/cTleIhnqLF3' },
      ...
      },
      {
        ...
        parentId: 'homeWorkout',
        videos: [
          { id: 'cTlZbPnY8CS', title: 'Close Grip Push Up', embedUrl: 'https://go.screenpal.com/player/cTlZbPnY8CS' },
      ...
      },
      {
        ...
        videos: [
          ...
          { id: 'cTlTQcnYPxh', title: 'Mountain Climbers', embedUrl: 'https://go.screenpal.com/player/cTlTQcnYPxh' },
          ...
          { id: 'cOfVD4nTBZ1', title: 'Resistance Band Squat to Press', embedUrl: 'https://go.screenpal.com/player/cOfVD4nTBZ1' },
